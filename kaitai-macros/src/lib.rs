...
fn create_type(map: &yaml::Hash, options: TypeOptions) -> proc_macro2::TokenStream {
    ...
    let parsed_meta = meta::parse_meta(meta).expect("error parsing meta: ");
    let parsed_seq = seq::parse_seq(seq);
